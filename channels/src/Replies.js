...
export const Replies = () => {
    ...
    const fetchPosts = async () => {
        try {
            const res = await axios.post("http://localhost:8080/replies", {post: id});
            setPosts(res.data);
        } catch (err) {
            console.log(err)
    ...
    const getRoot = async () => {
        try {
            const res = await axios.post("http://localhost:8080/getRoot", {id: id});
            setRoot(res.data)
        } catch (err) {
            console.log(err)
    ...
    // Handle like for the parent post
    ...
    // Update likes for the parent post
    ...
    // Handle dislike for the parent post
    ...
    // Update dislikes for the parent post
        ...
        <div>
            ...
            <div className="cmain">
                <div className="info">
                    ...
                    <Link to={`/channels/${name}`}><p className="back">Back to posts</p></Link>
                ...
                <div className="posts">
                    ...
                    {results && results.length > 0 ? (
                        ...
                        results.map(reply => (<div className="reply" key={reply.id}>
                            ...
                            <Link to={`/channels/${name}/${id}/replies/${reply.id}`}>
