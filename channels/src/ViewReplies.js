...
export const ViewReplies = () => {
    ...
    const fetchPosts = async () => {
        try {
            const res = await axios.get("http://localhost:8080/allReplies");
            setPosts(res.data);
    ...
    return (
        ...
        <div>
            ...
            <div className="cmain">
                <div className="info">
                    <span className="greentext">Replies </span> <a href='/deleteReply'>
                ...
                <div className="posts">
                    {results && results.length > 0 ? (
                        ...
                        results.map(post => (<div className="post" key={post.id}>
                                ...
                                <h3 className="time">Post ID: {post.postid}</h3>
